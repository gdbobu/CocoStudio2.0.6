...
// Type: CocoStudio.EngineAdapterWrap.V2F_C4B_T2F_Triangle
...
namespace CocoStudio.EngineAdapterWrap
{
  public class V2F_C4B_T2F_Triangle : IDisposable
  {
    ...
    public V2F_C4B_T2F a
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4B_T2F_Triangle_a_get(this.swigCPtr);
    ...
    public V2F_C4B_T2F b
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4B_T2F_Triangle_b_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V2F_C4B_T2F) null : new V2F_C4B_T2F(cPtr, false);
      }
      set
      {
    ...
    public V2F_C4B_T2F c
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4B_T2F_Triangle_c_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V2F_C4B_T2F) null : new V2F_C4B_T2F(cPtr, false);
      }
      set
      {
    ...
    public V2F_C4B_T2F_Triangle()
      : this(CocoStudioEngineAdapterPINVOKE.new_V2F_C4B_T2F_Triangle(), true)
    {
    }
