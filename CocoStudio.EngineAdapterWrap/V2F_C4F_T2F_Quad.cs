...
// Type: CocoStudio.EngineAdapterWrap.V2F_C4F_T2F_Quad
...
namespace CocoStudio.EngineAdapterWrap
{
  public class V2F_C4F_T2F_Quad : IDisposable
  {
    ...
    public V2F_C4F_T2F bl
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4F_T2F_Quad_bl_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V2F_C4F_T2F) null : new V2F_C4F_T2F(cPtr, false);
      }
      set
      {
    ...
    public V2F_C4F_T2F br
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4F_T2F_Quad_br_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V2F_C4F_T2F) null : new V2F_C4F_T2F(cPtr, false);
      }
      set
      {
    ...
    public V2F_C4F_T2F tl
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4F_T2F_Quad_tl_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V2F_C4F_T2F) null : new V2F_C4F_T2F(cPtr, false);
      }
      set
      {
    ...
    public V2F_C4F_T2F tr
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4F_T2F_Quad_tr_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V2F_C4F_T2F) null : new V2F_C4F_T2F(cPtr, false);
      }
      set
      {
    ...
    public V2F_C4F_T2F_Quad()
      : this(CocoStudioEngineAdapterPINVOKE.new_V2F_C4F_T2F_Quad(), true)
    {
    }
