...
// Type: CocoStudio.EngineAdapterWrap.V2F_C4F_T2F
...
namespace CocoStudio.EngineAdapterWrap
{
  public class V2F_C4F_T2F : IDisposable
  {
    ...
    public Vec2 vertices
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4F_T2F_vertices_get(this.swigCPtr);
    ...
    public Color4F colors
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4F_T2F_colors_get(this.swigCPtr);
    ...
    public Tex2F texCoords
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V2F_C4F_T2F_texCoords_get(this.swigCPtr);
    ...
    public V2F_C4F_T2F()
      : this(CocoStudioEngineAdapterPINVOKE.new_V2F_C4F_T2F(), true)
    {
    }
