...
// Type: CocoStudio.EngineAdapterWrap.V3F_C4B_T2F_Quad
...
namespace CocoStudio.EngineAdapterWrap
{
  public class V3F_C4B_T2F_Quad : IDisposable
  {
    ...
    public V3F_C4B_T2F tl
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V3F_C4B_T2F_Quad_tl_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V3F_C4B_T2F) null : new V3F_C4B_T2F(cPtr, false);
      }
      set
      {
    ...
    public V3F_C4B_T2F bl
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V3F_C4B_T2F_Quad_bl_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V3F_C4B_T2F) null : new V3F_C4B_T2F(cPtr, false);
      }
      set
      {
    ...
    public V3F_C4B_T2F tr
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V3F_C4B_T2F_Quad_tr_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V3F_C4B_T2F) null : new V3F_C4B_T2F(cPtr, false);
      }
      set
      {
    ...
    public V3F_C4B_T2F br
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V3F_C4B_T2F_Quad_br_get(this.swigCPtr);
        return cPtr == IntPtr.Zero ? (V3F_C4B_T2F) null : new V3F_C4B_T2F(cPtr, false);
      }
      set
      {
    ...
    public V3F_C4B_T2F_Quad()
      : this(CocoStudioEngineAdapterPINVOKE.new_V3F_C4B_T2F_Quad(), true)
    {
    }
