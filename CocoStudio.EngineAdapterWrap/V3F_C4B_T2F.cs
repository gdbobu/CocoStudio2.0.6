...
// Type: CocoStudio.EngineAdapterWrap.V3F_C4B_T2F
...
namespace CocoStudio.EngineAdapterWrap
{
  public class V3F_C4B_T2F : IDisposable
  {
    ...
    public Vec3 vertices
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V3F_C4B_T2F_vertices_get(this.swigCPtr);
    ...
    public Color4B colors
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V3F_C4B_T2F_colors_get(this.swigCPtr);
    ...
    public Tex2F texCoords
    {
      get
      {
        IntPtr cPtr = CocoStudioEngineAdapterPINVOKE.V3F_C4B_T2F_texCoords_get(this.swigCPtr);
    ...
    public V3F_C4B_T2F()
      : this(CocoStudioEngineAdapterPINVOKE.new_V3F_C4B_T2F(), true)
    {
    }
