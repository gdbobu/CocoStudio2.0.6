...
// Type: CocoStudio.UserStatistics.Aspect.TraceMethodExceptionAttribute
...
namespace CocoStudio.UserStatistics.Aspect
{
  internal class TraceMethodExceptionAttribute : OnMethodBoundaryAspect
  {
  }
}
