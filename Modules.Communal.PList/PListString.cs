...
// Type: Modules.Communal.PList.PListString
...
namespace Modules.Communal.PList
{
  public class PListString : PListElement<string>
  {
    ...
    public override byte TypeCode
    {
      get
      {
        return this.m_IsUTF16 ? (byte) 6 : (byte) 5;
      }
    }
    ...
    public override string Value
    {
      ...
      set
      {
        ...
        {
          if (!PListString.s_UTF8Chars.Contains(ch))
          {
            this.m_IsUTF16 = true;
            return;
          }
        }
        this.m_IsUTF16 = false;
      }
    }
